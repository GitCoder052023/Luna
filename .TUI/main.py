...
import questionary
from models.Ollama.medium_models import llama
from models.Ollama.medium_models import mistral
from models.Ollama.small_models import gemma_models
from models.Ollama.small_models import llama_models
    ...
    try:
        ...
        if query is not None:
            ...
            if any(command in query.lower() for command in stop_commands):
                console.print("Shutting down luna", style="bold red")
                ...
                console.print(ld, style="bold cyan")
                ...
                console.print("listening...", style="bold red")
